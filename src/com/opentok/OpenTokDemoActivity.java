...
import com.opentok.controlbar.ControlBarActivity;
import com.opentok.helloworld.HelloWorldActivity;
 ...
 */
public class OpenTokDemoActivity extends Activity {
    ...
    public void startHelloWorldApp() {
        ...
        Intent intent = new Intent(OpenTokDemoActivity.this, HelloWorldActivity.class);
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public void startControlBarApp() {
        ...
        Intent intent = new Intent(OpenTokDemoActivity.this, ControlBarActivity.class);
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
    }
}